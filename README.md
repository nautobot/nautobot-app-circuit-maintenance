...
Current exposed metric is the `circuit operational status` which shows the operational status for each Circuit depending on related Circuit Maintenances (1: Operational, 2: Under active maintenance):
